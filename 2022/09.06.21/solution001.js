...
//P: given a string or two words

//R: return the first letter of each word switched
...
function spoonerize(words) {
    words = words.split(' ')
    let firstWord = words[1][0] + words[0].slice(1)
    let secondWord = words[0][0] + words[1].slice(1)
